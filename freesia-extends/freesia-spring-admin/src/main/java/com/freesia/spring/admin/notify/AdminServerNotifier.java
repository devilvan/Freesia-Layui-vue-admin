package com.freesia.spring.admin.notify;
...
@Slf4j
@Component
public class AdminServerNotifier extends AbstractEventNotifier {

    protected AdminServerNotifier(InstanceRepository repository) {
        super(repository);
    }
