...
import {computed, defineComponent, inject, useSlots} from "vue";
import "./index.less";
import {CheckboxSize} from "@layui/layui-vue/types/component/checkbox/interface";
import useProps from "@layui/layui-vue/es/checkbox/index.hooks";

defineComponent({
  name: "DraggableLayCheckbox"
})
