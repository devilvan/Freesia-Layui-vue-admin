...
public class PageQuery {
    ...
    private List<OrderItem> buildOrderItem() {
        ...
        String orderBy = USql.escapeOrderBySql(orderByColumn);
        orderBy = UString.toUnderlineCase(orderBy);

        // 兼容前端排序类型
        isAsc = StringUtils.replaceEach(isAsc, new String[]{"ascending", "descending"}, new String[]{"asc", "desc"});

        String[] orderByArr = orderBy.split(UString.SEPARATOR);
        String[] isAscArr = isAsc.split(UString.SEPARATOR);
